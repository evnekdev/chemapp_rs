...
//!
//! Exact per-routine function types are intentionally written out so ABI
//! argument order remains reviewable against the platform evidence.
...
fn fixed_fortran_string(buffer: &[u8], character_length: usize) -> Result<String, ChemAppError> {
    ...
    let end = record[..nul_end]
        ...
        .map(|last| last + 1)
        .unwrap_or(0);
    Ok(from_utf8(&record[..end])?.to_owned())
}
...
impl Engine {
    ...
    pub fn tqgtpi(&self) -> Result<String, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_result(fixed_fortran_string(&cstring, NAME_LENGTH_MAX)?, errcode)
    }
    ...
    pub fn tqgted(&self) -> Result<(u32, u32), ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_result((), errcode)?;
        Ok((chemapp_int_to_u32(month)?, chemapp_int_to_u32(year)?))
    }
    ...
    pub fn tqsize(&self) -> Result<SystemDimensions, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_result((), errcode)?;
        system_dimensions_from_raw(dims)
    }
    ...
    pub fn tqgio(&self, option: &str) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(num, errcode)
    }
    ...
    pub fn tqgsu(&self, option: &str) -> Result<String, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_result(fixed_fortran_string(&cunit, NAME_LENGTH_MAX)?, errcode)
    }
    ...
    pub fn tqinsc(&self, name: &str) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(indexs, errcode)
    }
    ...
    pub fn tqgnsc(&self, indexs: usize) -> Result<String, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_result(fixed_fortran_string(&cname, NAME_LENGTH_MAX)?, errcode)
    }
    ...
    pub fn tqnosc(&self) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(nscom, errcode)
    }
    ...
    pub fn tqstsc(&self, indexs: usize) -> Result<(Vec<f64>, f64), ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_result((stoi, wmass), errcode)
    }
    ...
    pub fn tqinp(&self, name: &str) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(indexp, errcode)
    }
    ...
    pub fn tqnop(&self) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(nphase, errcode)
    }
    ...
    pub fn tqinpc(&self, indexp: usize, name: &str) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(indexc, errcode)
    }
    ...
    pub fn tqnopc(&self, indexp: usize) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(nconst, errcode)
    }
    ...
    pub fn tqnosl(&self, indexp: usize) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(nosl, errcode)
    }
    ...
    pub fn tqnolc(&self, indexp: usize, index: usize) -> Result<usize, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_nonnegative_result(nosc, errcode)
    }
    ...
    pub fn tqgsp(&self, indexp: usize) -> Result<String, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_result(fixed_fortran_string(&cstatus, NAME_LENGTH_MAX)?, errcode)
    }
    ...
    pub fn tqerr(&self) -> Result<String, ChemAppError> {
        ...
        /******************************************************************************************************/
        wrap_result(tqerr_message(&cmess)?, errcode)
    }
    ...
    pub fn tqgpar(
        ...
        tqgpar_values(&vala, leading_dimension, noexpr, nvala)
    }
